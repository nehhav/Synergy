                ...
                <div class="row">
                    ...
                    <div id="load_tweets2"><?php  include('sidebar.php'); ?></div>
                        ...
                        <?php if($ttttt=="WINDOWS"){ ?>
                            	<li ><a href="home.php"><img src="../images/windows.png" width="40" height="40" />BSC-IT</a></li>
                            
                            
                      <?php  }
                      
                        if($ttttt=="MAC"){ ?>
                            	<li ><a href="mac.php"><img src="../images/mac.png" width="40" height="40" /> BMS</a></li>
                       ...
                       if($ttttt=="LINUX")
                        { ?>
                              <li ><a href="linux.php"><img src="../images/linux.png" width="40" height="40" />BMM</a></li>
                            
                        <?php } ?>
                        
                        
                            <?php   if($ttttt=="ANDROID"){ ?>
                            	<li  ><a href="android.php"><img src="../images/android.png" width="40" height="40" /> BAFTNMP</a></li>
                        <?php } ?>
                        
                        
                            <?php   if($ttttt=="PROGRAMMING"){ ?>
                             <li ><a href="program.php"><img src="../images/program.png" width="40" height="40" /> EVENTS/FESTS</a></li>
                            
                        <?php } ?>
                        
                          <?php   if($ttttt=="HARDWARE"){ ?>
                            	<li ><a href="hardware.php"><img src="../images/hardware.png" width="40" height="40" /> ADMISSIONS/CONCESSIONS</a></li>
